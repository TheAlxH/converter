...
static const yytype_uint16 yyrline[] =
{
     ...
     604,   611,   620,   681,   733,   740,   797,   810,   823,   830,
        ...
        if (!pp->hadError) {
          ...
          if (!pp->hadError) {
            if ((yyvsp[(13) - (13)].oVarSpecVec)()) {
              ...
              if (!pp->hadError) {
                  //std::cout << "THIS IS $5 and $11 " << $5 << " and " << $11 << std::endl;
                for (int i=0; i<(yyvsp[(5) - (13)].iValue); i++) {
                  ...
                  if (ivsv->alias) {
                    ...
                    pp->intvars.push_back(varspec(std::string((yyvsp[(11) - (13)].sValue))+"["+to_string(i+1)+"]", ivsv));
                  }
            ...
            if (!pp->hadError) {
              for (int i=0; i<(yyvsp[(5) - (13)].iValue); i++) {
                ...
                if (bvsv->alias)
                  ...
                  pp->boolvars.push_back(varspec(std::string((yyvsp[(11) - (13)].sValue))+"["+to_string(i+1)+"]", (*vsv)[i]));
                }
                if (!pp->hadError && (yyvsp[(9) - (13)].oSet)()) {
                  Option<AST::SetLit*> opt =
                    Option<AST::SetLit*>::some(new AST::SetLit(*(yyvsp[(9) - (13)].oSet).some()));                    
